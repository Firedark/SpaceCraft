 ...
 */
public class EnemyShipD extends GenEnemigo {
    ...
    public EnemyShipD(SpaceCraft game, LogicalGame table,int salud,int reward,Texture texturaEnemigo, Texture texturaDisparo) {
        super.reward = 20;
        super.game = game;
        this.table = table;
        super.salud = salud;
