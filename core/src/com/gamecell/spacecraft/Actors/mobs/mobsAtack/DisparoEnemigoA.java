 ...
 */
public class DisparoEnemigoA extends GenDisparoEnemigo {
    ...
    public DisparoEnemigoA(SpaceCraft game, GenEnemigo enemigo,LogicalGame logical,Texture texture, float tiempo){
